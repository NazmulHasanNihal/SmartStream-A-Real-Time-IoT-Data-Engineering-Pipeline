...
# Set query params (modern method)
st.query_params.clear()

# Auto-refresh every 10 seconds
st.experimental_data_editor  # used to trigger Streamlit to load experimental features
st_autorefresh = st.experimental_rerun  # fallback-safe (won't be used in loop)
st.experimental_rerun  # no longer needed in body; remove if causing confusion

# Supabase DB connection using secrets
db_uri = (
...
# Auto-refresh via Streamlit native
st.experimental_autorefresh(interval=2000, key="dashboard-refresh")
